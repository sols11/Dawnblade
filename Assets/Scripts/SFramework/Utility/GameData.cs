...
namespace SFramework
{
    ...
    public class GameData
    {
        ...
        public GameData()
        {
            ...
            Fit[(int)FitType.Cloth]= UnityHelper.FindDic(GameMainProgram.Instance.dataBaseMgr.dicEquip, "学生服");
            Fit[(int)FitType.Shoe]= UnityHelper.FindDic(GameMainProgram.Instance.dataBaseMgr.dicEquip, "学生鞋");
            // 初始背包，1~31值为-1
            PropNum = new int[32];
            for (int i = 1; i < 32; i++)
                PropNum[i] = -1;
