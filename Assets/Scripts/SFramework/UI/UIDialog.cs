...
namespace SFramework
{
    public class UIDialog:ViewBase
    {
        ...
        private void Awake()
        {
            ...
            GameMainProgram.Instance.eventMgr.StartListening(EventName.DialogActionComplete, OnDialogActionComplete);
        }
        ...
        {
            GameMainProgram.Instance.eventMgr.StopListening(EventName.DialogActionComplete, OnDialogActionComplete);
        }
        ...
        /// <summary>
        /// 当对话后的Action结束时调用，使角色可以行动
        /// </summary>
        private void OnDialogActionComplete()
        {
            // 结束对话，可以移动
            IsTalking = false;
            // 拉远相机
