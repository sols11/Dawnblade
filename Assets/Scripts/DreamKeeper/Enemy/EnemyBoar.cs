...
namespace DreamKeeper
{
    ...
    /// Enemy编程模板
    /// </summary>
    public class EnemyBoar : IEnemy
    {
        private string aniDead = "Dead";
        //private BoarMono boarMono;

        public EnemyBoar(GameObject gameObject) : base(gameObject)
        {
            ...
            Debug.Log("生成Enemy 野猪的属性：" + CurrentHP + "," + AttackPoint + "," + DefendPoint + "," + CritPoint);
            // 行为树的开启由动画调用
		}
